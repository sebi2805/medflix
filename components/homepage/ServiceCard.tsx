    ...
    <div className={combinedClasses} style={style}>
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-4xl font-semibold mb-4">{price} RON</p>
          <hr className="mb-4 border-t-2 border-darkGreen-600 w-full mx-auto" />{" "}
        </div>
        <div className="mb-4">
          <Medal />
        </div>
      ...
      {/* Divider */}
      <ul className="mb-4 flex-1 list-disc">
